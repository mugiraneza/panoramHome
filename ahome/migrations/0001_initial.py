    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('home', 'Home')], default='home', max_length=250)),
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='propertie', to='ahome.city')),
            ],
        ),
        migrations.CreateModel(
            name='PlanProperty',
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='planProperty', to='ahome.propertie')),
            ],
        ),
        migrations.CreateModel(
            name='ImageProperty',
